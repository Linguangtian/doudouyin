	   ...
	   <div class="tab-pane fade in active" id="home">
			<table class="table table-striped table-bordered table-hover" style="margin-top: 10px;">
				...
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td><?php if($vo["id"] > 2): echo ($vo["rebate_price_4"]); endif; ?></td>
						...
						<td><a class="btn btn-default btn-xs" href="javascript:;" data-id="<?php echo ($vo["id"]); ?>" data-name="<?php echo ($vo["name"]); ?>" data-price="<?php echo ($vo["price"]); ?>" data-rebate_price_1="<?php echo ($vo["rebate_price_1"]); ?>" 
                               data-rebate_price_2="<?php echo ($vo["rebate_price_2"]); ?>" data-rebate_price_3="<?php echo ($vo["rebate_price_3"]); ?>" data-rebate_price_4="<?php echo ($vo["rebate_price_4"]); ?>"  day_limit_task_num="<?php echo ($vo["day_limit_task_num"]); ?>" data-remark="<?php echo ($vo["remark"]); ?>"
				...
				<form id="bjy-form" class="form-inline" action="<?php echo U('edit');?>" method="post">
					...
					<table class="table table-striped table-bordered table-hover table-condensed">
                        ...
                        <tr class="tr_rebate_price_4" style="display: none;">
                            <th>四级及以上推荐人返佣：</th>
                            <td>
                                <input class="form-control" type="text" name="rebate_price_4">
                            </td>
                        </tr>

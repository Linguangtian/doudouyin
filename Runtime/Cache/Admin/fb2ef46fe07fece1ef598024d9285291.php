                ...
                <form class="form-inline submit-ajax" data-refresh="3" role="form" method="post">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            <th>状态：</th>
                            <td>
                                <select name="user_status" class="input col-xs-12 col-sm-2">
                                    <option value="1" <?php if($info['user_status'] == 1): ?>selected<?php endif; ?> >正常</option>
                                    <option value="2" <?php if($info['user_status'] == 2): ?>selected<?php endif; ?> >封号</option>
                                </select>
                            </td>
                        </tr>
                        <tr>

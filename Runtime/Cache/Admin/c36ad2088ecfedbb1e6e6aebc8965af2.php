...
<table class="table table-striped table-bordered table-hover table-condensed">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
            ...
            <td>
                <?php if($vo["user_status"] == 1): ?>正常<?php else: ?>封号<?php endif; ?>
            </td>
            <td>
                ...
                <a href="javascript:;" class="btn btn-default btn-xs" data-id="<?php echo ($vo["id"]); ?>" data-username="<?php echo ($vo["username"]); ?>" onclick="point_chongzhi(this)">信用分充值</a>
                ...
                <a href="<?php echo U('Pay/point_log',array('member_id'=>$vo['id']));?>" class="btn btn-default btn-xs layer-dialog" title="信用分明细：<?php echo ($vo["nickname"]); ?>">信用分明细</a>
...
<div class="modal fade" id="point_chongzhi_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_point_chongzhi" class="form-inline" action="<?php echo U('point_chongzhi');?>" method="post">
                    <input type="hidden" name="member_id">
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        <tr>
                            <th>账号：</th>

...
<form class="form-inline" method="post">
    <table class="table table-bordered table-hover" style="max-width: 800px;">
        ...
        <tr>
            ...
            <td>
                <input name="web_logo" id="web_logo" type="text" class="input col-xs-12 col-sm-5" size="40" value="<?php echo ($info["web_logo"]); ?>" /> <input type="button" class="btn btn-info"  onclick="flashupload('web_logo', '上传文件', 'web_logo', return_value, '<?php echo CONTROLLER_NAME;?>');" value="浏览..">
            </td>
        </tr>
        <tr>
            <th width="150">
        ...
        <tr>
            ...
            <td>
                <input name="wx_kf_qrcode" id="wx_kf_qrcode" type="text" class="input col-xs-12 col-sm-5" size="40" value="<?php echo ($info["wx_kf_qrcode"]); ?>" /> <input type="button" class="btn btn-info"  onclick="flashupload('wx_kf_qrcode', '上传文件', 'wx_kf_qrcode', return_value, '<?php echo CONTROLLER_NAME;?>');" value="浏览..">
            </td>
        </tr>
        <tr>
            <th width="150">
            ...
            <td>
                <input type="text" name="qq_kf" value="<?php echo ($info["qq_kf"]); ?>" class="form-control"/>
            </td>
        </tr>
        <tr>
            <th width="150">
            ...
            <td>
                <input name="qq_kf_qrcode" id="qq_kf_qrcode" type="text" class="input col-xs-12 col-sm-5" size="40" value="<?php echo ($info["qq_kf_qrcode"]); ?>" /> <input type="button" class="btn btn-info"  onclick="flashupload('qq_kf_qrcode', '上传文件', 'qq_kf_qrcode', return_value, '<?php echo CONTROLLER_NAME;?>');" value="浏览..">
            </td>
        </tr>
        <!--
        <tr>
